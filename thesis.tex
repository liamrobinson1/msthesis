...
\include{ch-literature}

%%% BACKGROUND
\include{ch-coordinate-systems}
\include{ch-attitude-reprs}
\include{ch-light-curves}
\include{ch-photometry}
\include{ch-background-signals}

%%% METHOD
\include{ch-light-curve-simulation}
\include{ch-light-curve-inversion}

%%% RESULTS

%%% CONCLUSION
\include{ch-recommendations}
\include{ch-future-work}
\include{ch-appendices}
