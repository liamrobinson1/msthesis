...
Eq \ref{eq:u_qual} can be interpreted in terms of the statistical properties of the light curve just like Eq \ref{eq:unc_quantity}. Under the assumption that the EGI optimized by NNLS produces a good estimator for the mean of the measured light curve, noisier measurements with higher variance will produce a larger residual $\delta \hat{I}_{tot,j}$ regardless of the signal magnitude. 
